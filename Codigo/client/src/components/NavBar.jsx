    ...
    <>
      <nav className="fixed top-0 left-0 w-full  border-indigo-950 bg-gradient-to-b from-indigo-950 to-transparent dark:border-indigo-950 z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <button onClick={toggleMobileMenu} className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-indigo-950 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-indigo-950 dark:focus:ring-indigo-950" aria-expanded={isMobileMenuOpen ? "true" : "false"}>
