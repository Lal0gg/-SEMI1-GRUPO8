    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen">
            <div className="card  h-5/6 absolute border-2 border-bluebell bg-gradient-to-b from-bluebell from-[12%] via-[12%] via-slate-100 to-70% to-slate-300 shadow-lg rounded-xl w-8/12 flex justify-center items-center text-white">
                ...
                <div className="absolute right-40 top-1/2 transform -translate-y-16">
                    <div className="text-left">
                        <h1 className="text-black text-2xl">Eduardo Josué Gonzalez Cifuentes</h1>
                        <h1 className="text-gray-500 text-2xl">@lal0ggggggggggggggggggggggg</h1>
                    </div>
                </div>
