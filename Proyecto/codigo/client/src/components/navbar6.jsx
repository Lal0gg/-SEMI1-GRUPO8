...
export default function NavBar4() {
    ...
    const irPaginaMain = () => {
        navigate('/viewlistseriesadmi');
    }

    const irSubirCaptitulo = () => {
        navigate('/main');
    }
                        ...
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-500 md:dark:bg-indigo-950 dark:border-gray-700">
                            ...
                            <li className="relative">
                                ...
                                <div className={`absolute top-full left-0 z-20 ${isDropdownOpen ? 'block' : 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-indigo-950 dark:divide-indigo-950`}>
                                    ...
                                    <div className="py-1">
                                        <a onClick={irPaginaMain} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-indigo-950  dark:text-gray-200 dark:hover:text-white">Mangas y Comics / Admin</a>
                                    </div>
                                    <div className="py-1">
                                        <a onClick={irSubirCaptitulo} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-indigo-950  dark:text-gray-200 dark:hover:text-white">Crear Series</a>
                                    </div>
                                    <div className="py-1">
