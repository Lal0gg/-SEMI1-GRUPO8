                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className={`absolute top-full left-0 w-full md:relative md:flex md:w-auto ${isMobileMenuOpen ? 'block' : 'hidden'} md:block`} id="navbar-dropdown">
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-500 md:dark:bg-indigo-950 dark:border-gray-700">
                            <li>
                                <a onClick={irHome} className="block py-2 px-3 text-gray-900 rounded hover:bg-indigo-950md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Home</a>
                            </li>
                            <li className="relative">
                                ...
                                <div className={`absolute top-full left-0 z-20 ${isDropdownOpen ? 'block' : 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-indigo-950 dark:divide-indigo-950`}>
                                    ...
                                    <div className="py-1">
                                        <a onClick={irViewSeriesGeneral} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-indigo-950  dark:text-gray-200 dark:hover:text-white">General</a>
                                    </div>
                                    <div className="py-1">
                                        <a onClick={irMainPrivate} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-indigo-950  dark:text-gray-200 dark:hover:text-white">Mis Mangas</a>
                                    </div>
                                    <div className="py-1">
                                        <a onClick={irCrearSeriePriv} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-indigo-950  dark:text-gray-200 dark:hover:text-white">Crear Serie</a>
                                    </div>
                                    <div className="py-1">
